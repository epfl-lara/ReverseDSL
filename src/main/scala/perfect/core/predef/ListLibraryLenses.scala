...
trait ListLibraryLenses extends ListLibraryLensesLike { self: ProgramUpdater
  ...
  with TreeModificationLenses with ADTLenses =>
  ...
  object MapLens extends MapLensLike(ApplicationExtractor, InvocationExtractor, ListLiteral, ListInsertLensGoal, ListLibraryOptions, ADT, TreeModificationLensGoal)
