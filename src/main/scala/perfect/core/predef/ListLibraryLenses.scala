...
/**
  ...
  */
trait ListLibraryLenses { self: ProgramUpdater
  ...
  /** Lense-like filter */
  case object FilterLens extends InvocationLens with FilterLike[Exp]  { // TODO: Incorporate filterRev as part of the sources.
...
//    Log(s"recombineArgumentLambdas($e)")
  ...
  case object MapLens extends InvocationLens {
